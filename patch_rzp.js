  ...
  `let order;
    try {
      ...
      if (rzpErr.statusCode === 401) {
        throw new AppError("Invalid Razorpay API keys.", 500, "Payment processing is currently unavailable due to invalid gateway configuration. Please contact support.");
      }
