...
export const Toast: React.FC<ToastProps> = ({ message, type = 'success', onClose, duration = 3000 }) => {
  ...
  return (
    <div 
        className={`fixed bottom-6 left-1/2 transform -translate-x-1/2 z-[100] flex items-center px-4 py-3 rounded-xl shadow-2xl text-white ${bgColor} transition-all duration-300 ease-spring ${
