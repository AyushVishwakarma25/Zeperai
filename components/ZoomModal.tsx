...
const ZoomModal: React.FC<ZoomModalProps> = ({ image, onClose }) => {
  ...
  return (
    <div 
      className="fixed inset-0 bg-black bg-opacity-80 z-[100] flex items-center justify-center p-4 cursor-grab"
      onClick={onClose}
    ...
    >
        <button 
            className="absolute top-4 right-4 text-white bg-black/50 hover:bg-black/80 rounded-full p-2 z-[102]"
            onClick={onClose}
            aria-label="Close"
        >
        ...
        >
         ...
         <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-black/60 text-white text-sm px-4 py-2 rounded-full z-[101] backdrop-blur-sm">
