...
}> = ({ images, onSetZoomedImage, onStartEdit, onSaveModel, isInfluencerMode }) => {
    ...
    <div className="w-full h-full bg-white flex flex-col">
        ...
        <main className="flex-grow flex flex-row overflow-hidden">
            <div className="flex-1 overflow-y-auto">
                {isFashionOrInfluencer ? ( <div className="p-4 md:p-6"><FashionReviewStudio images={props.generatedImages} onSetZoomedImage={props.onSetZoomedImage} onStartEdit={props.onStartEdit} onSaveModel={props.onSaveModel} isInfluencerMode={isInfluencer} /></div> ) : (
