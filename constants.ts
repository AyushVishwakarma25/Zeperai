...
export const PRO_PRODUCT_STYLE_PRESETS: ProProductStyleCategory[] = [
  {
    ...
    "presets": [
      { "name": "Citrus Pop", "prompt": "A [product] placed on a white block with sliced citrus and ice cubes, fresh condensation, vibrant gradient background, bright studio lighting.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/design-citrus-pop.webp" },
      { "name": "Tropical Splash", "prompt": "A [product] surrounded by floating fruits and water splashes, dynamic motion freeze, colorful gradient backdrop, high contrast lighting.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/design-tropical-splash.webp" },
      { "name": "Minimal Refresh", "prompt": "A single [product] on a clean pedestal with subtle droplets, soft shadows, and a pastel gradient background.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/design-minimal-refresh.webp" },
      { "name": "Flavor Burst", "prompt": "A [product] surrounded by its core ingredients in mid-air, sharp detail, vivid background, strong directional lighting.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/design-flavor-burst.webp" },
      { "name": "Summer Glow", "prompt": "A [product] bottle shot on reflective surface with fresh fruits around, warm sunlight tone, minimal props.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/design-summer-glow.webp" },
      { "name": "Cool Lift", "prompt": "A levitating [product] with floating ice and vapor mist, clean blue or mint background, cinematic depth and clarity.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/design-cool-lift.webp" },
      { "name": "Vibrant Ingredient Pile", "prompt": "A professional studio shot of the [product] placed centrally on a generous, artful pile of its fresh, whole and sliced ingredients. The background is a clean, vibrant, single-color or soft gradient that matches the product's color palette. The lighting is bright and clean, making the product and ingredients look fresh and appealing, with subtle condensation on the bottle. The overall style is commercial, vibrant, and appetizing.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/design-vibrant-ingredient-pile.webp" },
      { "name": "Vibrant Geo-Steps", "prompt": "A dynamic commercial composition featuring multiple units of [product] arranged on colorful geometric stepped blocks (yellow, pink, lavender). The products are placed at different heights and angles on the steps to create a playful, stacked arrangement. The background is a solid, vibrant blue. Hard sunlight-style lighting creates sharp, defined shadows for a pop-art aesthetic. High-contrast, multipurpose advertising photography.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/design-vibrant-geo-steps.webp" },
      { "name": "Human Connection Stack", "prompt": "A creative composition of three hands with diverse skin tones holding [product], stacked vertically against a plain, light neutral background. Soft, natural studio lighting highlighting the packaging details. Minimalist and modern.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/design-two-hands-holding-product.webp" }
    ]
  },
  {
    "category": "Skincare & Beauty",
    "presets": [
      { "name": "Soft Glow", "prompt": "A [product] tube on pastel background with subtle shadows, minimalist props like petals or leaves, smooth editorial lighting.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Skincare/design-soft-glow.webp" },
      { "name": "Hand Reveal", "prompt": "A hand emerging through a colored paper background holding a [product], bold color contrast, high-end studio lighting.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Skincare/design-hand-reveal.webp" },
      { "name": "Natural Essence", "prompt": "A [product] bottle placed among stones and green leaves, soft daylight tone, spa-inspired composition.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Skincare/design-natural-essence.webp" },
      { "name": "Stone Elegance", "prompt": "A [product] on textured stone block with moody warm lighting and shadow play, premium product photography style.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Skincare/design-stone-elegance.webp" },
      { "name": "Clean Balance", "prompt": "A [product] bottle surrounded by clean ingredients like aloe, cucumber, or citrus, white background, minimalistic setup.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Skincare/design-clean-balance.webp" },
      { "name": "Luxe Mirror", "prompt": "A [product] placed on a reflective mirrored base, subtle gradients in background, glossy reflections, editorial feel.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Skincare/design-luxe-mirror.webp" },
      { "name": "Bold Sunlight Shadow", "prompt": "A minimalist product shot of [product] against a solid, vibrant background. A single, hard light source from the side or top creates a sharp, dramatic shadow, mimicking direct sunlight. The composition is clean, modern, and highlights the product's shape and color.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Skincare/design-bold-sunlight-shadow.webp" }
    ]
  },
  {
    "category": "Snacks & Packaged Foods",
    "presets": [
      { "name": "Hero Box Reach", "prompt": "A high-energy commercial photoshoot for [product]. A human arm reaches upwards from a branded brown cardboard box that is overflowing with many units of [product]. The person is holding one [product] aloft against a bold, solid red background. The foreground surface is a clean white square-tiled surface with red grout lines. Sharp studio lighting with energetic composition and vibrant colors.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-hero-box-reach.webp" },
      { "name": "Artisanal Tile Setup", "prompt": "Appetizing professional photography of [product]. Multiple units of [product] are standing upright on a smooth white stone countertop. In front of the packs, the actual loose snack pieces are artfully displayed in small minimalist terracotta and stone ceramic dishes. The background is a vibrant yellow square-tiled wall with a floating rustic wooden shelf. The shelf holds dark green ceramic jars and a lush leafy indoor plant. Bright, clean natural lighting with soft side-shadows for a fresh, premium look.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-artisanal-tile-setup.webp" },
      { "name": "Pop Color Spread", "prompt": "A modern graphic commercial spread of [product] packages against a high-contrast two-tone background consisting of a magenta-pink wall and a bright red floor. One unit of [product] stands upright while others lie artfully at angles. The scene is decorated with scattered ingredients relevant to the [product]'s flavor and small white porcelain bowls containing the product. Sharp editorial lighting with hard shadows creating a graphic and trendy aesthetic.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-pop-color-spread.webp" },
      { "name": "Dynamic Bundle Showcase", "prompt": "A professional studio group shot of the provided products arranged as a premium bundle. A central anchor element (like a box or main package) is positioned in the lower-ground. The other items are arranged artfully around it few lie on surface: place one on top of the central element, lean others against the base, and place flat items in the foreground. Soft, diffused studio lighting from the upper right. Background: A studio soft pastle, or brand colors). High-end commercial photography style, eye-level, sharp focus.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-pop-shot.webp" },
      { "name": "Healthy Indulgence", "prompt": "A [product] on beige fabric or wood, surrounded by its key ingredients (e.g. oats, nuts, chocolate chunks), soft warm lighting.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-healthy-indulgence.webp" },
      { "name": "Pop Shot", "prompt": "A single [product] packet surrounded by floating ingredients that represent its flavor, clean pastel background.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-pop-shot.webp" },
      { "name": "Vibrant Shelf", "prompt": "Rows of [product] displayed symmetrically on white cubes, bold lighting, contrasting shadows, magazine aesthetic.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-vibrant-shelf.webp" },
      { "name": "Dramatic Podium Shot", "prompt": "A dramatic, moody shot of the [product] centered on a dark, textured stone or wood podium. The background is dark and out of focus, with a single spotlight illuminating the product. Crumbs or small pieces of the product are scattered artfully on the podium. Cinematic, high-contrast lighting with sharp focus on the packaging.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-dramatic-podium-shot.webp" },
      { "name": "Modern E-comm Showcase", "prompt": "A clean, minimalist studio shot of the [product]. The product is placed on a reflective surface, creating a soft mirror image below. The background is a smooth, simple gradient using brand-cohesive colors. The lighting is bright, even, and professional, ideal for online stores and marketing materials.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-modern-e-comm-showcase.webp" },
      { "name": "Hands-On Flat Lay", "prompt": "A clean, top-down flat lay composition on a bold, solid-colored background. Two hands are in the frame, presenting both the [product] packaging and the product in use (e.g., in a bowl). The lighting is bright and even, creating a modern, graphic, and engaging look ideal for social media.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-hands-on-flat-lay.webp" },
      { "name": "Vibrant Breakfast Scene", "prompt": "A vibrant, energetic lifestyle shot of [product] as part of a breakfast scene. Includes a bowl of the product, a glass of milk, and other relevant props. The shot can be from a top-down or a dynamic three-quarter angle, possibly featuring a hand interacting with the scene (e.g., holding a spoon, pouring milk). The background is a bright, solid color and the lighting is hard, creating crisp shadows for a playful, modern feel.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-vibrant-breakfast-scene.webp" },
      { "name": "Quickcommerce Style", "prompt": "A professional studio shot of the [product] placed centrally in a scene with its key ingredients and final form (e.g., brownies, a prepared dish) artfully scattered around it. The background is a clean, warm, soft-focus gradient that complements the product's colors. The lighting is dramatic yet soft, creating an appetizing and high-quality commercial look. Include dynamic elements like small splashes or floating ingredients for a vibrant, premium feel.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-quickcommerce-style.webp" },
      { "name": "Blinkit Style 2", "prompt": "Studio shot of a standing [product] on a sky or smooth gradient background, with a soft spotlight from the corners and subtle shadows. Add realistic water droplets on the packaging if appropriate for the product. Surround the [product] with its key ingredients, artfully arranged in a rich food styling composition. Premium commercial photography style with crisp details and a shallow depth of field. Do not add any other elements. The [product] should be the main focus, filling approximately 85% of the frame.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-blinkit-style-2.webp" },
      { "name": "Color Block Pop", "prompt": "Three [product] items displayed against a vibrant background featuring bold diagonal color blocks (purple, red, blue). Hard directional lighting creates long, dramatic shadows. Graphic, high-contrast pop-art aesthetic.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-color-block-pop.webp" },
      { "name": "Hero Product", "prompt": "A stunning 'Hero Product' composition of [product]. The background is a solid, vibrant color that dynamically matches the product's primary branding color for a seamless, monochromatic look. The product stands boldly in the center. In the background, a bowl or artful arrangement of the product's key ingredients (e.g., grains, fruits, nuts, spices) is displayed to showcase flavor and quality. The lighting is soft yet defining, highlighting the texture of the packaging and the freshness of the ingredients. High-end commercial aesthetic.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Snacks%20/design-vibrant-breakfast-scene.webp" }
    ]
  },
  {
    "category": "Perfume & Luxury",
    "presets": [
      { "name": "Mirror Elegance", "prompt": "A [product] placed on a reflective surface with moody background gradient, soft light highlights, luxury aesthetic.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/design-luxe-mirror.webp" },
      { "name": "Water Grace", "prompt": "A [product] bottle half-submerged in calm water with ripples and reflections, golden light glow.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/design-tropical-splash.webp" },
      { "name": "Silk Touch", "prompt": "A [product] placed on smooth flowing fabric folds, soft diffused lighting, gentle highlights.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Skincare/design-soft-glow.webp" },
      { "name": "Amber Night", "prompt": "A [product] bottle on marble or glass with warm amber light and cinematic shadows, elegant composition.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Skincare/design-stone-elegance.webp" },
      { "name": "Minimal Luxury", "prompt": "A single [product] centered in frame on matte background with sharp top light, premium editorial style.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/design-minimal-refresh.webp" },
      { "name": "Botanical Aura", "prompt": "A [product] surrounded by delicate petals or herbs, soft daylight and depth blur, high-end fragrance style.", "thumbnail": "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Skincare/design-natural-essence.webp" }
    ]
  },
  {
  ...
  },
  {
    ...
    "presets": [
      { "name": "Geometric Pedestal", "prompt": "A [product] placed on a clean, white geometric pedestal with soft shadows and a warm, minimalist background. Elegant and high-end studio lighting." },
      { "name": "Emerald Bokeh", "prompt": "A [product] suspended in front of a dark green textured background with beautiful bokeh lights. Dramatic and luxurious lighting with a focus on gemstones." },
      { "name": "Teardrop Blue", "prompt": "A [product] placed on a light blue textured surface with soft, diffused lighting. Clean and sophisticated composition." },
      { "name": "Hand Model Showcase", "prompt": "A professional hand model wearing the [product], showcasing its fit and detail. Soft, natural lighting with a blurred lifestyle background." },
      { "name": "Royal Velvet Bust", "prompt": "A [product] displayed on a professional jewellery mannequin bust with a rich velvet finish. Dramatic spotlighting to highlight craftsmanship and sparkle." },
      { "name": "Luxury Box Reveal", "prompt": "A [product] presented inside a luxury velvet jewellery box, nestled in soft fabric. Rich, warm lighting with elegant textures (silk or velvet)." }
    ]
  }
];
    ...
    presets: [
      {
        ...
        thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/Herbal%20Gulal%20Box.webp"
      },
      {
        ...
        thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/Vibrant%20Color%20Spread.webp"
      },
      {
        ...
        thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/Festive%20Gift%20Hamper.webp"
      },
      {
        ...
        thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/design-vibrant-gulal-explosion.webp"
      },
      {
        ...
        thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/design-elegant-white-pastel.webp"
      }
    ]
  },
  {
    ...
    presets: [
      {
        ...
        thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/Golden%20Glow%20Diya.webp"
      },
      {
        ...
        thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/Royal%20Card%20Party.webp"
      },
      {
        ...
        thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/Traditional%20Rangoli.webp"
      },
      {
        ...
        thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/Mythological%20Art%20style.webp"
      }
    ]
  },
  {
    category: "🌙 Eid",
    presets: [
      { name: "Moonlight Feast", prompt: "Elegant evening setting. [product] placed on an ornate tray with dates and lanterns. Background features a crescent moon glow. Rich blue and gold tones.", thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/Golden%20Glow%20Diya.webp" },
      { name: "Morning Celebration", prompt: "Bright and airy Eid morning. [product] on a white marble table with sheer curtains and soft sunlight. Simple elegant props like a tasbih.", thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/Traditional%20Rangoli.webp" }
    ]
  },
  {
    category: "🎄 Christmas",
    presets: [
      { name: "Cozy Fireplace", prompt: "Warm Christmas vibe. [product] placed on a wooden mantelpiece with stockings and pine cones. Soft glow from a fireplace in the background.", thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/design-vibrant-gulal-explosion.webp" },
      { name: "Winter Wonderland", prompt: "Crisp winter scene. [product] nestled in fake snow with silver ornaments and white pine branches. Cool blue and white lighting.", thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/design-elegant-white-pastel.webp" },
      { name: "Gift Unboxing", prompt: "Exciting holiday gift scene. [product] emerging from a wrapped gift box with ribbons and confetti. Bright, joyful lighting.", thumbnail: "https://kvqzfiezakcbnxbagxjs.supabase.co/storage/v1/object/public/thumbnails/Festiveshoot/Vibrant%20Color%20Spread.webp" }
    ]
  }
];
